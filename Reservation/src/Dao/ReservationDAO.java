...
public class ReservationDAO extends BaseHibernateDAO {
	...
	public List findByExample(Reservation instance) {
		...
		try {
			List results = getSession().createCriteria("Model.Reservation")
	...
	public List findByTablenum(Object tablenum) {
		return findByProperty(TABLENUM, tablenum);
	}

	public List findByRetime(Object retime) {
		return findByProperty(RETIME, retime);
	}
