...
public class TableDAO extends BaseHibernateDAO {
	...
	public static final String RE_FLAG = "reFlag";
	...
	public Table findById(java.lang.String id) {
		...
		try {
			Table instance = (Table) getSession().get("Model.Table", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Table instance) {
		...
		try {
			List results = getSession().createCriteria("Model.Table")
	...
	public List findByReFlag(Object reFlag) {
		return findByProperty(RE_FLAG, reFlag);
	}
